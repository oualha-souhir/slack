...
async function getFournisseurOptions() {
	try {
		const values = await getConfigValues("fournisseur_options", [
			"Fournisseur Ab",
			"Fournisseur Bv",
			"Fournisseur dC",
		]);
		...
		return [
			{
				text: { type: "plain_text", text: "Fournisseur Aa" },
				value: "fournisseur_aA",
			},
			{
				text: { type: "plain_text", text: "Fournisseur Bb" },
				value: "fournisseur_bB",
			},
			{
				text: { type: "plain_text", text: "Fournisseur Cc" },
				value: "fournisseur_cC",
			},
